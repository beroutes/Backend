...
export class UsuariosComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.usuariosService
      ...
      .subscribe((res: HttpResponse<IUsuarios[]>) => this.paginateUsuarios(res.body, res.headers));
  }
  ...
  registerChangeInUsuarios(): void {
    this.eventSubscriber = this.eventManager.subscribe('usuariosListModification', () => this.reset());
  }
  ...
  protected paginateUsuarios(data: IUsuarios[] | null, headers: HttpHeaders): void {
