...
import { SeguidoresComponent } from 'app/entities/seguidores/seguidores.component';
...
describe('Component Tests', () => {
  describe('Seguidores Management Component', () => {
    let comp: SeguidoresComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SeguidoresComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.seguidores && comp.seguidores[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
