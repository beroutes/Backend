...
public interface UserProfileRepository extends JpaRepository<UserProfile, Long> {
    ...
    @Query(value = "select distinct userProfile from UserProfile userProfile left join fetch userProfile.followers",
    ...
    @Query("select distinct userProfile from UserProfile userProfile left join fetch userProfile.followers")
    List<UserProfile> findAllWithEagerRelationships();

    @Query("select userProfile from UserProfile userProfile left join fetch userProfile.followers where userProfile.id =:id")
