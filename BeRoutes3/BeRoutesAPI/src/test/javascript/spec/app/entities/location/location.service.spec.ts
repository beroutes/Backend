...
describe('Service Tests', () => {
  describe('Location Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Location(0, 0, 'AAAAAAA', 'AAAAAAA', 0, 0, 'AAAAAAA', 0, 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Location', () => {
        const returnedFromService = Object.assign(
          {
            stepPosition: 1,
            titleLocation: 'BBBBBB',
            descriptionLocation: 'BBBBBB',
            xCoordinate: 1,
            yCoordinate: 1,
            stepDuration: 'BBBBBB',
            qrCode: 1,
            qrDescription: 'BBBBBB',
            createdAt: currentDate.format(DATE_TIME_FORMAT),
            updatedAt: currentDate.format(DATE_TIME_FORMAT)
          },
          elemDefault
