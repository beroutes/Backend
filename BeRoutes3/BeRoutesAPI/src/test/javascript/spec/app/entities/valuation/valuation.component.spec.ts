...
import { ValuationComponent } from 'app/entities/valuation/valuation.component';
...
describe('Component Tests', () => {
  describe('Valuation Management Component', () => {
    let comp: ValuationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ValuationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.valuations && comp.valuations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
