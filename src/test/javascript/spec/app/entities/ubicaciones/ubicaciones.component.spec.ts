...
import { UbicacionesComponent } from 'app/entities/ubicaciones/ubicaciones.component';
...
describe('Component Tests', () => {
  describe('Ubicaciones Management Component', () => {
    let comp: UbicacionesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UbicacionesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ubicaciones && comp.ubicaciones[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
