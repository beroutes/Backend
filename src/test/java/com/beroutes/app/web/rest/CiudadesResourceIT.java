...
public class CiudadesResourceIT {
    ...
    public void checkNombreIsRequired() throws Exception {
        int databaseSizeBeforeTest = ciudadesRepository.findAll().size();
        // set the field null
        ciudades.setNombre(null);

        // Create the Ciudades, which fails.
        ...
        List<Ciudades> ciudadesList = ciudadesRepository.findAll();
        assertThat(ciudadesList).hasSize(databaseSizeBeforeTest);
    }
