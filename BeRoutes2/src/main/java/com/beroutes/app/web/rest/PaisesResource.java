...
import com.beroutes.app.repository.PaisesRepository;
...
/**
 * REST controller for managing {@link com.beroutes.app.domain.Paises}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PaisesResource {
    ...
    public ResponseEntity<Paises> updatePaises(@Valid @RequestBody Paises paises) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paises.getId().toString()))
            .body(result);
    }
