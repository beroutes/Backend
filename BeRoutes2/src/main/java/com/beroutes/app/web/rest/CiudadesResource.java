...
import com.beroutes.app.repository.CiudadesRepository;
...
/**
 * REST controller for managing {@link com.beroutes.app.domain.Ciudades}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CiudadesResource {
    ...
    public ResponseEntity<Ciudades> createCiudades(@Valid @RequestBody Ciudades ciudades) throws URISyntaxException {
     ...
     */
    @PutMapping("/ciudades")
    public ResponseEntity<Ciudades> updateCiudades(@Valid @RequestBody Ciudades ciudades) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ciudades.getId().toString()))
            .body(result);
    }
